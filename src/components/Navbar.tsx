        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 gap-4">
            ...
            <div className="flex items-center gap-1.5 shrink-0">
              ...
              <Button variant="ghost" size="icon" className="relative text-zinc-300 hover:text-white hover:bg-white/10">
                <Heart size={18} />
              ...
              <div className="hidden sm:flex items-center gap-1">
                <Link to="/login">
                  <Button variant="ghost" className="text-zinc-300 hover:text-white hover:bg-white/10 text-sm gap-1.5 h-9">
                    <User size={15} /> Account
                  </Button>
                </Link>
                <Link to="/signup">
                  <Button className="bg-white text-black border-0 text-sm h-9 hover:bg-zinc-200">
                    Sign Up
                  </Button>
                </Link>
              </div>
        ...
        <div className="border-t border-white/10 bg-zinc-950">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center gap-1 h-10 overflow-x-auto scrollbar-none">
              <button className="flex items-center gap-1.5 text-xs text-zinc-300 hover:text-white whitespace-nowrap px-3 py-1.5 rounded-lg hover:bg-white/10 transition-all font-semibold border border-white/10 mr-2">
                <Menu size={13} /> All Categories <ChevronDown size={12} />
              </button>
              {categories.map((cat) => (
                <a
                  key={cat.label}
